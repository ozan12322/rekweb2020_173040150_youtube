...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyAT2dkDygEYjTZbj_T9CeFjZsobK-T0IHM');

$youtubeProfilePic = $result['items'][0]['snippet']['thumbnails']['medium']['url'];
$channelName = $result['items'][0]['snippet']['title'];
$subscriber = $result['items'][0]['statistics']['subscriberCount'];

$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyAT2dkDygEYjTZbj_T9CeFjZsobK-T0IHM&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet';
